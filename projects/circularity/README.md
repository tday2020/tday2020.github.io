...
We know we want to draw 100 circles, and that the `for` loop is the way go, so let's go ahead and put the for loop in place. We've provided an outline of the for loop for you; 
