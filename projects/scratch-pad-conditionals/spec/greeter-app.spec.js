describe("#greeter-app", function () {
    ...
    it('should print "Good Morning!" if hour is between 0 and 11', function () {
        greeter(0);
        expect(console.log.firstCall.calledWith('Good Morning!'), 'a').to.be.true;
        greeter(11);
        expect(console.log.secondCall.calledWith('Good Morning!'), 'b').to.be.true;
        greeter(12);
        expect(console.log.thirdCall.calledWith('Good Morning!'), 'c').to.be.false;
    });
    it('should print "Good Afternoon!" if hour is between 12 and 16', function () {
        greeter(12);
        expect(console.log.firstCall.calledWith('Good Afternoon!'), 'a').to.be.true;
        greeter(16);
        expect(console.log.secondCall.calledWith('Good Afternoon!'), 'b').to.be.true;
        greeter(17);
        expect(console.log.thirdCall.calledWith('Good Afternoon!'), 'c').to.be.false;
